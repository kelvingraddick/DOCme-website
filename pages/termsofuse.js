...
import { APP_BASE_URL } from '../helpers/urls';
      ...
      <div className="bg-white shadow sm:rounded-lg mt-4">
        <div className="grid justify-items-center px-4 py-5 sm:p-6">
          ...
          <div className="text-sm">
            ...
            <p>You acknowledge that you have read this Agreement and agree to all its terms and conditions. By accessing and using the Services you agree to be bound by this Agreement. If you do not agree to abide by the terms of this Agreement, you are not authorized to access or use the Services. This terms and conditions policy was created with the <a target="_blank" href="https://www.websitepolicies.com/terms-and-conditions-generator">terms and conditions generator</a>.</p>
            <br />
            <b>Contacting us</b>
            ...
            <p>fagu&#101;b&#111;r&#64;&#103;&#109;ail.&#99;o&#109;</p>
            <br />
            <p><i>This document was last updated on January 4, 2022</i></p>
          </div>
        </div>
      </div>
      <style jsx>{`
